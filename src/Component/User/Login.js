    ...
    if (mobileNumber && password) {
      try {
        ...
        if (loginResponse.loginResult.status) {
          ...
          setPrimaryTitle("Invalid Credentials");
          setSecondaryTitle("Please enter correct Credentials");
        ...
        <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
          <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            ...
            >
              ...
              {isValid && (
                <div
                  className="bg-blue-100 border-t-4 border-blue-500 rounded-b text-teal-900 px-4 py-3 mb-4 shadow-md"
                  role="alert"
                >
                  <div className="flex">
                    <div className="py-1">
                    ...
                    <div>
                      <p className="font-bold">{primaryTitle}</p>
