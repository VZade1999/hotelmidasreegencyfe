...
const Bookroom = () => {
  ...
  return (
    <>
      ...
      {!roomdata.length && (
        <div className="pt-4">
          <div class="mx-auto max-w-screen-lg bg-blue-900 p-8 text-white md:flex md:items-center md:justify-around md:p-16 lg:rounded-xl">
            <div class="mr-10 mb-10 md:mb-0">
              <h2 class="mb-8 max-w-lg text-3xl font-bold sm:text-4xl">
              ...
              <ul class="flex max-w-xl flex-wrap gap-4">
                ...
                <li class="flex space-x-2">
                  ...
                  <p class="text-gray-100">
                    Corporate / Couple Friendly / Pet Friendly Rooms are
                    available
                  </p>
                </li>
              </ul>
            ...
            <div class="whitespace-nowrap">
              <button class="focus:outline-4 rounded-xl bg-gray-900 px-4 py-3 font-medium text-white shadow-md outline-white transition cursor-default">
                Try these now
              </button>
            </div>
          </div>
