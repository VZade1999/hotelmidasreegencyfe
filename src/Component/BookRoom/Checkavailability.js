...
const Checkavailability = () => {
  ...
  return (
    <div className="flex p-5 justify-center banner dark:bg-gray-900 ps-5">
      <div className="flex flex-col justify-around md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 w-full ">
        <div>
      <span className="text-white me-5">Check-In</span>
        ...
        <DatePicker
          ...
          className="bg-gray-50 checkInInput border border-gray-300 text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 px-4 py-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full"
